                            ...
                            <div class="posts">
                                ...
                                <div class="post">
                                    ...
                                    <div class="post-content">
                                        <h2><a href="{{url('blog-detail')}}">لورم ایپسوم یا طرح‌نما</a></h2>
                                    ...
                                    <div class="post-meta clearfix">
                                        ...
                                        <div class="post-meta-more"><a href="{{url('blog-detail')}}">ادامه مطلب <i class="fa fa-chevron-left"></i></a></div><!-- /.post-meta-more -->
                                    </div><!-- /.post-meta -->
                                </div><!-- /.post -->
